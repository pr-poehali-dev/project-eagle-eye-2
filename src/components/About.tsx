  ...
  return (
    <section id="о нас" className="py-20 px-4" style={{ background: "#080d1a" }}>
      <div className="max-w-5xl mx-auto">
        <p className="text-xs font-bold tracking-widest text-gray-500 uppercase mb-10">ОБО МНЕ</p>
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">Делаю дизайн для бизнеса с помощью нейросетей.</p>
            <div
            ...
            >
              <p className="text-gray-200 leading-relaxed">
                Пока другие тратят{" "}
                <span className="text-white font-bold">100–300к на агентства</span>{" "}
                и ждут месяц — мои клиенты получают результат за{" "}
