const plans = [
  {
    ...
    price: "от 1 990₽",
    items: [
      "1 карточка — главный слайд + инфографика",
      "или 1 обложка ВК",
      "или логотип Старт (1 концепция)",
    ],
    accent: "#cd7f32",
  ...
  },
  {
    ...
    price: "от 4 990₽",
    items: [
      "3 карточки товара — полный комплект слайдов",
      "или логотип Бизнес (2 концепции + SVG)",
  ...
  },
  {
    ...
    items: [
      "Каталог (20+ стр.)",
      "+ логотип Премиум (3 концепции + все форматы)",
