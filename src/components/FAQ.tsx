...
const faqs = [
  {
    q: "Это реальные фото или нейросеть?",
    a: "Генерирую нейросетью и дорабатываю. Не отличить от профессиональной съёмки.",
  },
  {
    q: "Сколько времени занимает сайт?",
    a: "Лендинг — 2–3 дня. Многостраничный — 5–7 дней.",
  },
  {
    q: "На чём делаете сайты?",
    a: "На нейро платформах.",
  },
  {
    q: "А если не понравится?",
    a: "Макет бесплатный. Не нравится — не платите.",
  },
  {
    q: "Можно ли вносить правки?",
    a: "До 3 правок включены в стоимость.",
  },
];
